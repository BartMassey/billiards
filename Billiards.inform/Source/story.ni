...
A ball is a kind of thing. A ball has a color. A ball has a number called the mark. A ball has a truth state called sunkenness. The description of it is usually "This [item described] is painted [color of the item described][if the mark of the item described is greater than 0], and labeled with a [mark of the item described] in a white circle[end if]." Sunkenness is usually false.
...
Definition: A ball is sunk if the sunkenness of it is true.

To sink (B - a ball): now the sunkenness of B is true.
